...
<div class="wrap">
    <div class="container" >
        <h2>Add New  <?= '- '.get_the_title( $_GET['page_id'] ); ?></h2> 
        ...
        <input type="submit" class="btn btn-primary" value="Save" name="update_request">     
            ...
            <div class="row">
                <div class="form-container">
                        ...
                        <?php if(isset($_GET['status']) && $_GET['status']  == "insert"): ?>
                            ...
                            <div class="panel-body" >
                                ...
                                <div class="form-group" >
                                    ...
                                    <div class="col-lg-3">
                                        ...
                                        <input type="hidden" name="data[head_picture][]" class="custom-img-id">                                           
                                    </div>
                                </div>
                    ...
                    <!--End page heading logos-->
                        ...
                        <div class="form-group">
                            ...
                            <div class="button_container">
                                ...
                                <input type="submit" class="btn btn-primary" value="Save" name="new_request">                                
                            </div>
                            </div>
                        </div>
...
var cnt =1;
  ...
  $("body").on( 'click', '.upload-custom-img', function( event ){
    ...
    frame.on( 'select', function() {
      ...
      imgContainer.append( '<img src="'+attachment.url+'" alt="" class="imgthumb"/>' );
