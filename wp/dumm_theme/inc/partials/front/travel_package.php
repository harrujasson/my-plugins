                ...
                <div class="col-12 col-sm-6 col-md-5 col-lg-4 col-xl-4 mt-5">
                    <div class="inner sliderBox">
                        ...
                        <div class="cntnt">
                            ...
                            <p class="rating"><i class="fas fa-map-marker-alt"></i> <strong><?=$this->getmetinfo($r->ID,'travel_package_country')?></strong></p>
                        ...
                        <div class="completeDesc">
                            <p>
                                <a href="<?php echo get_permalink($r->ID);?>">Explore Package</a>
                            </p>
                        </div>
                    </div>
                </div>
