...
Class MWPL_Themeoptions{
    ...
    function mwpl_save_theme_settings() {
                ...
                switch ( $tab ){ 
                    case 'footer' : 
                            ...
                            case 'general' : 
                                    ...
                                    $settings['mwpl_picture']	  = $_POST['mwpl_picture'];
                            break;
                    case 'social' : 
            ...
            if( !current_user_can( 'unfiltered_html' ) ){
                    ...
                    if ( $settings['mwpl_picture'] )
                            $settings['mwpl_picture'] = stripslashes( esc_textarea( wp_filter_post_kses( $settings['mwpl_picture'] ) ) );
