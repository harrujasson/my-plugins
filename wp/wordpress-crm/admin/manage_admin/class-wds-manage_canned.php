...
class WDS_Admin_Manage_Canned  {
    ...
    function edit(){
        ...
        if(!isset($_GET['id'])){
            ...
            @wp_redirect(admin_url('admin.php?page=mwpl_ticket_canned'));
            return false;
        }
        if($_GET['id'] ==""){
            $this->notice('Invalid Request, Please try again!','error');
    ...
    function show_list(){ 
        ...
        foreach($details as $k=>$v){
            $button = '<a title="Edit" href="admin.php?page=mwpl_ticket_canned_edit&id='.$v['id'].'"><i class="fa fa-pencil"></i></a>&nbsp;&nbsp;';
