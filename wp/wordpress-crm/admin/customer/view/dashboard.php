...
<h1 class="h3 mb-3 font-weight-normal">Your Tickets </h1>
    <div class="ticket-system-content text-left">
        ...
        <div class="row mt-3">
            <a href="<?= site_url() ?>/customer-ticket/create" class="btn btn-primary submit-ticket-btn">Submit Ticket</a>  &nbsp;
            <a href="<?= site_url() ?>/customer-ticket/history" class="btn btn-primary submit-ticket-btn">Ticket History</a>  &nbsp;
        </div>
...
$(document).ready(function() {
        ...
        var table = $("#reportList").DataTable({ 
            ...
            "fnServerParams": function ( aoData ) {
                aoData.push( { "name": "action", "value": "ticketinfocustomer" } );
                aoData.push( { "name": "search_subject", "value": $("#search_subject").val() } );
