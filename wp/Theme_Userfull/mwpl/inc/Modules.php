...
Class MWPL_Modules{
    ...
    function MWPL_Create_CPT(){
        ...
        $this->section_init('mwpl_university','University', true, array( 'title','thumbnail','editor'), 'University Picture', 'dashicons-welcome-learn-more');
        $this->section_init('mwpl_packages','Travel Packages', true, array( 'title','thumbnail','editor'), 'Location Picture','dashicons-location-alt');
        $this->section_init('mwpl_client_review','Client Reviews', false, array( 'title','thumbnail'), 'Client Picture', 'dashicons-format-chat');
        $this->section_init('mwpl_country_slider','Country Work',false,array( 'title','thumbnail','editor'), 'Country Picture', 'dashicons-admin-site-alt3');
    }
