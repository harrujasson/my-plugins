...
class Wds_Activator {
	...
	public static function activate() {
            ...
            $tickets_table_name = $wpdb->prefix . "mwpl_tickets";                    
            ...
            $tickets_logs_table_name = $wpdb->prefix . "mwpl_ticket_assigned";
            ...
            $tickets_comments_table_name = $wpdb->prefix . "mwpl_tickets_comments";
            ...
            $canned_table_name = $wpdb->prefix . "mwpl_canned";
            ...
            if(empty($check_page_exist)) {
                $page_id = wp_insert_post(
                    ...
                    'post_status'    => 'publish',
                    'post_content'   => '[wds-customer-ticket-dashboard]',
                    'post_type'      => 'page'
                    )
                );
                if($page_id){
